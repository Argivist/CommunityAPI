...
io.on("connection", (socket) => {
    ...
    socket.on("register", (data) => {
        ...
        console.log(data);
        db.query('Insert into users (fname,lname,nickname,email,pwd,email,hobby,interest,genre) values(?,?,?,?,?,?,?,?,?)',[data.fname,data.lname,data.nname,data.email,data.pwd],(err,result)=>{
            if(err){

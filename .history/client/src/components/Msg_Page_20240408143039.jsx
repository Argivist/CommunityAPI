                    ...
                    foundFriends.map((friend, index) => {
                        if (friend.username !== 'failed') {
                            if (!addedFriends.includes(friend.id)) {
                                return <option key={index} value={friend.username}>Added</option>
                            }else{
                                return <option key={index} value={friend.username}>{friend.username}</option>
                            }
                        } else {
                            return <option key={index} value="No user found">No user found</option>
                        }

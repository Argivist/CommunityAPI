        ...
        <>
            <div id="ChatList" className="chatlist nochat ">
                ...
                <div className="toolbox">
                    <button id="toolhidden" className="tools hidden">a</button>
                    <button id="toolhidden" className="tools hidden">b</button>
                    <button id="toolhidden" className="tools hidden">c</button>
                    <button id="toolhidden" className="tools hidden">d</button>
                    <button className="close" onClick={()=>{
                        document.getElementsByClassName('tools hidden').className="tools shown";
                    }}>X</button>                </div>
            </div>
        </>
    );

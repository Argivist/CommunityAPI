...
const MsgRoomProvider = ({ children }) => {
    ...
    return (
        <MsgRoomContext.Provider value={{ Room, setRoom,RoomName,setRoomName, joinRoom, leaveRoom, messageList, setMessageList }}>
            {children}
...
const Chate = ({ id, pic, name, recent }) => {
    const { Room,setRoom,RoomName,setRoomName, joinRoom,leaveRoom,setMessageList } = useMsgRoom();

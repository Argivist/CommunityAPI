                    ...
                    ()=>{
                        setOverlapContent(
                            <Overlap title={
                                ...
                                <Status statmessage="This feature is not available yet" />
                            } />
                        )
                        setOverlap(true);
...
function RandomFriend() {
    ...
    return (
        <div>
            {
                socket.on("found_friendn", (data) => {
                    return <FriendButton friend={data.nickname} friendid={data.uid} />
                })
            }
        </div>
    );

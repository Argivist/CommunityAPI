                    ...
                    <button className="close" onClick={() => {
                            ...
                            if (tools.className == "hidden") {
                                ...
                                toolButtons.forEach(button => {
                                    ...
                                    button.style.animation = "appear_top 0.5s ease forwards";
                                });
                            } else {
                                // Hide the tools with animation
                                toolButtons.forEach(button => {
                                    button.style.animation = "disappear_top 0.5s ease forwards";
                                });
                        
                                // After animation, hide the tools
                                setTimeout(() => {
                                ...
                                }, 500); // Adjust timing according to the animation duration
                            }

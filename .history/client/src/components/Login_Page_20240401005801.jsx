...
const UserProvider = ({ children }) => {
  ...
  const register=async (user,pwd,fname,lname,nname,email,hobby,interest,genre)=>{
  await  socket.emit('register', { user,pwd,fname,lname,nname,email,hobby,interest,genre });
  await  socket.on('rstatus', (status) => {

    ...
    return (
        <>
            <div className="messageSection">
                <Message us_them={true} message={"this is a train message"} nickname={"MOI"} time={"23:05"}/>
                <Message us_them={false} message={"this is a test message"} nickname={"TOI"} time={"23:15"}/>

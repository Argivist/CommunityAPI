        ...
        <>
            <div id="ChatList" className="chatlist nochat ">
                ...
                <div className="toolbox">
                    <button id="tools" className="tools hidden">a</button>
                    <button id="tools" className="tools hidden">b</button>
                    <button id="tools" className="tools hidden">c</button>
                    <button id="tools" className="tools hidden">d</button>
                    <button className="close" onClick={()=>{
                        document.getElementsById('tools').id="toolshown";

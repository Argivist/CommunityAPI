...
const Msg_Page = () => {
    const  {overlap, setOverlap, overlapcontent, setOverlapContent} = useMsgRoom();
    return (
        <MsgRoomProvider>
            ...
            <div className="home">
                ...
                {overlap? <Overlap title="Error" content={overlapcontent} /> : null 
...
function Overlap({ title, content }) {
    const {overlap,setOverlap} = useMsgRoom();
    return (
        <>

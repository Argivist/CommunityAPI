...
const Message_Section = () => {
    ...
    const bottom_of_panel_ref = useRef < HTMLDivElement > (null);
    useEffect(() => {
    ...
    useEffect(
        () => {
            if (bottom_of_panel_ref) {
                bottom_of_panel_ref.scrollIntoView({ behavior: "smooth" });
            }
        }, []
    );
    return (
        <div className="messageSection">
            ...
            <div ref={bottom_of_panel_ref}></div>
        </div>
    );
};
